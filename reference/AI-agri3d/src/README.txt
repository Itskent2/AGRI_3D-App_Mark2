...
# Edge Impulse library for Weed Detection

This is a C++ library that lets you run the impulse for "Weed Detection" (https://studio.edgeimpulse.com/studio/923987) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
